...
const statuses = {
  "online" : "<:online:983992323820118076>",
  "idle" : "<:idle:983992319520931861>",
  "dnd" : "<:dnd:983992321509052447>",
  "offline" : "<:offline:983992461380710442>",
}
module.exports = {
  name: "userinfo",
  aliases: ["uinfo"],
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    try {   
      ...
      try{
        ...
        embeduserinfo.setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true })))
        ...
        embeduserinfo.setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: user.tag}), user.displayAvatarURL({ dynamic: true })))
