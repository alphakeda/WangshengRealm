...
module.exports = {
    ...
    try{
      ...
      .setAuthor(client.getAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif"))], ephemeral: true})
      cpuStat.usagePercent(function (e, percent, seconds) {
        ...
        const botinfo = new Discord.MessageEmbed()
            .setAuthor(client.getAuthor(client.user.tag + " Information", client.user.displayAvatarURL())) 
