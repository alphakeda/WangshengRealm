...
module.exports = {
    ...
    try{
        ...
        let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed().setColor(es.color)
          .setAuthor(client.getAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif"))
        ]}).catch(console.error)
        ...
        return Promise.all(promises)
          .then(([cluster, shards, guilds, members, ram, rssRam, ping, dbPing, players, uptime]) => {
              ...
              for(let index = 0; index<shards.length; index++) {
                ...
                .setAuthor(client.getAuthor(client.user.username + " Information", client.user.displayAvatarURL())) 
                ...
                .addField(
                  `${uptime[index] < 1000 || members[index] < 1 || guilds[index] < 1 ? `<:dnd:983992321509052447>` : `<:online:983992323820118076>`} Cluster #${cluster[index]}${cluster[index] == client.cluster.id ? ` | **Cluster of __this Guild__**` : ``}`, 
