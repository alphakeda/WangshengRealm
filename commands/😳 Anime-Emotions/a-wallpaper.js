...
module.exports = {
  name: "a-wallpaper",
  aliases: ["wallpaper", "awallpaper", "animewallpaper", "anime-wallpaper"],
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    message.reply({embeds : [
        ...
        .setAuthor(`${message.author.username} here's a wallpaper!`, message.author.displayAvatarURL({ dynamic: true }))
    ]}).catch(() => {})
