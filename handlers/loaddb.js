...
module.exports = async client => {
    return new Promise(async (res) => {
        ...
        console.log(`[x] :: `.magenta + `Connected to Mongo DB `.brightGreen)
        ).catch((err) =>
        console.log(`[x] :: `.magenta + `Could not connect to mongo DB `.RED))
        ...
        process.env.DB_cache_ping = 60_000; // Delete the cache after X ms | < 0 === never delete [DEFAULT: 60_000]
