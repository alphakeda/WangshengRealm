  ...
  try {
    ...
    if (type.split(":")[1] === "add") {
      ...
      var embed2 = new MessageEmbed()
        .setDescription(`:thumbsup: **Queued :notes: [${res.tracks[1].title}](${res.tracks[1].uri})**`)
        .setColor(ee.color)
        .setThumbnail(`https://img.youtube.com/vi/${res.tracks[1].identifier}/mqdefault.jpg`)
        .addField("⌛ Duration: ", `\`${res.tracks[1].isStream ? "LIVE STREAM" : format(res.tracks[1].duration)}\``, true)
        .addField("💯 Song By: ", `\`${res.tracks[1].author}\``, true)
